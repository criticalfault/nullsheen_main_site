---
title: "The Matrix Program Package - A Gem from the Early Days of Decking"
date: 2026-06-09T12:00:00Z
draft: false
authors: ["Dean"]
tags: ['Decking', 'Archive', 'Tools']
...
You can find the project and download it directly from SourceForge: [Matrix Program Package on SourceForge](https://sourceforge.net/projects/cyberspace/)
...
![Automated Matrix Runner](/images/matrix_program_suite/AutomatedMatrixRunner.jpg)
...
![Matrix Construction Set](/images/matrix_program_suite/MatrixConstructionSet.jpg)
...
![Deck Builder](/images/matrix_program_suite/DeckBuilder.jpg)

![Decker Builder](/images/matrix_program_suite/DeckerBuilder.jpg)
...
![Matrix Randomizer](/images/matrix_program_suite/MatrixRandomizer..jpg)

## Running It Today

This was built for Windows 3.x and 95, so getting it running on a modern machine takes a little work. The good news is it absolutely still runs today — you just need [winevdm](https://github.com/otya128/winevdm), which adds support for legacy 16-bit Windows applications on 64-bit systems. Install it, point it at the executable, and you are in business. This is also useful for other programs on the software page if they are no longer runnable on Windows 10 or 11.

You can also grab the zip from the [Software and Tools](/software) page under the 1st and 2nd Edition section.
